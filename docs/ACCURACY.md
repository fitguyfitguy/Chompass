...
Typed or text entry ("2 eggs and toast", a barcode scan, a saved meal) is close to
solved. Canonical foods with known grams or units usually come back exact or
near-exact.
...
("1 cup") is measurably more reliable than a photo alone.
...
same 50-photo set. That result is why the portion-chip UX is next.
