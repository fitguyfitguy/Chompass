...
- **Coach sees your average intake by default** (Android + web): the coach now knows your average calories and macros over your recent logged days without needing to look them up, so questions like "how am I doing" get an immediate, grounded answer. With day types on, it weighs single days against that day's target and the week against the weekly average.
