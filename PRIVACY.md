...
| Health Connect | Nutrition, weight, body fat (if you enable sync) | Google Health Connect on-device |
| App update check | Installed version (Play builds only) | Google Play |
