  ...
  return {
    ...
    recipes: (input.recipes ?? []).map((r) => {
      ...
      return {
        ...
        nutrition_calories: r.nutritionCalories ?? null,
        nutrition_protein_g: r.nutritionProtein ?? null,
        nutrition_carbs_g: r.nutritionCarbs ?? null,
        nutrition_fat_g: r.nutritionFat ?? null,
        nutrition_fiber_g: r.nutritionFiber ?? null,
        nutrition_sugar_g: r.nutritionSugar ?? null,
        nutrition_sodium_mg: r.nutritionSodium ?? null,
...
export function liveRecipesFromSync(wires) {
  return wires
    ...
    .map((w) => ({
      ...
      nutritionCalories: w.nutrition_calories ?? null,
      nutritionProtein: w.nutrition_protein_g ?? null,
      nutritionCarbs: w.nutrition_carbs_g ?? null,
      nutritionFat: w.nutrition_fat_g ?? null,
      nutritionFiber: w.nutrition_fiber_g ?? null,
      nutritionSugar: w.nutrition_sugar_g ?? null,
      nutritionSodium: w.nutrition_sodium_mg ?? null,
