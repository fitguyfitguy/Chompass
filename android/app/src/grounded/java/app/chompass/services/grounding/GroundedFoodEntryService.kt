...
import app.chompass.models.GroundingValidator
...
class GroundedFoodEntryService(
    ...
    private suspend fun analyzeWithToolLoop(
        ...
        onProgress: (FoodAnalysisProgress) -> Unit,
        historyPool: List<app.chompass.models.FoodEntry>,
    ...
    private suspend fun buildHistoryPool(): List<app.chompass.models.FoodEntry> {
    ...
    private fun historyToAnalysis(
        entry: app.chompass.models.FoodEntry,
        grams: Double,
        component: RecognizedFoodComponent,
    ): FoodAnalysis {
