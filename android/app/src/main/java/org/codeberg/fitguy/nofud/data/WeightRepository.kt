...
import org.codeberg.fitguy.nofud.services.health.ExternalWeight
    ...
    suspend fun addEntry(entry: WeightEntry): WeightGoalReachedEvent? {
        ...
        if (profile != null && goal != null && previousLatest != null) {
            val crossed = when (profile.goal) {
                org.codeberg.fitguy.nofud.models.WeightGoal.LOSE ->
                    previousLatest.weightKg > goal && entry.weightKg <= goal
                org.codeberg.fitguy.nofud.models.WeightGoal.GAIN ->
                    previousLatest.weightKg < goal && entry.weightKg >= goal
                org.codeberg.fitguy.nofud.models.WeightGoal.MAINTAIN -> false
            }
