...
enum class ExerciseSort(val titleRes: Int) {
    NAME(org.codeberg.fitguy.nofud.R.string.label_name),
    LEVEL(org.codeberg.fitguy.nofud.R.string.label_level),
    PRIMARY(org.codeberg.fitguy.nofud.R.string.label_primary),
    SECONDARY(org.codeberg.fitguy.nofud.R.string.label_secondary),
    CATEGORY(org.codeberg.fitguy.nofud.R.string.label_category),
    FORCE(org.codeberg.fitguy.nofud.R.string.label_force),
    MECHANIC(org.codeberg.fitguy.nofud.R.string.label_mechanic),
    EQUIPMENT(org.codeberg.fitguy.nofud.R.string.label_equipment)
}
