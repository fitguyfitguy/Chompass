...
enum class ExerciseSort(val titleRes: Int) {
    NAME(com.fitguy.nofud.R.string.label_name),
    LEVEL(com.fitguy.nofud.R.string.label_level),
    PRIMARY(com.fitguy.nofud.R.string.label_primary),
    SECONDARY(com.fitguy.nofud.R.string.label_secondary),
    CATEGORY(com.fitguy.nofud.R.string.label_category),
    FORCE(com.fitguy.nofud.R.string.label_force),
    MECHANIC(com.fitguy.nofud.R.string.label_mechanic),
    EQUIPMENT(com.fitguy.nofud.R.string.label_equipment)
}
