package com.fitguy.nofud.services.health
...
class HealthConnectManager(private val context: Context) {
    ...
    private fun mealTypeFor(meal: com.fitguy.nofud.models.MealType): Int = when (meal) {
        com.fitguy.nofud.models.MealType.BREAKFAST -> HCMealType.MEAL_TYPE_BREAKFAST
        com.fitguy.nofud.models.MealType.LUNCH -> HCMealType.MEAL_TYPE_LUNCH
        com.fitguy.nofud.models.MealType.DINNER -> HCMealType.MEAL_TYPE_DINNER
        com.fitguy.nofud.models.MealType.SNACK -> HCMealType.MEAL_TYPE_SNACK
        com.fitguy.nofud.models.MealType.OTHER -> HCMealType.MEAL_TYPE_UNKNOWN
    }

    private fun mealTypeFrom(hcMealType: Int): com.fitguy.nofud.models.MealType = when (hcMealType) {
        HCMealType.MEAL_TYPE_BREAKFAST -> com.fitguy.nofud.models.MealType.BREAKFAST
        HCMealType.MEAL_TYPE_LUNCH -> com.fitguy.nofud.models.MealType.LUNCH
        HCMealType.MEAL_TYPE_DINNER -> com.fitguy.nofud.models.MealType.DINNER
        HCMealType.MEAL_TYPE_SNACK -> com.fitguy.nofud.models.MealType.SNACK
        else -> com.fitguy.nofud.models.MealType.OTHER
    }
...
data class ExternalNutrition(
    val time: Instant,
    val name: String?,
    val mealType: com.fitguy.nofud.models.MealType,
    val calories: Double?,
    val protein: Double?,
    val carbs: Double?,
    val fat: Double?,
