...
internal data class SettingsPrefsHydration(
    ...
    val fastingStartReminderHour: Int,
    val fastingStartReminderMinute: Int,
...
internal fun Preferences.toSettingsHydration(json: Json): SettingsPrefsHydration {
    ...
    return SettingsPrefsHydration(
        ...
        fastingStartReminderHour = (this[Keys.FASTING_START_REMINDER_HOUR] ?: DEFAULT_FASTING_START_REMINDER_HOUR).coerceIn(0, 23),
        fastingStartReminderMinute = (this[Keys.FASTING_START_REMINDER_MINUTE] ?: DEFAULT_FASTING_START_REMINDER_MINUTE).coerceIn(0, 59),
