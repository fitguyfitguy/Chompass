...
internal data class SettingsPrefsHydration(
    ...
    val streakReminderHour: Int,
    val streakReminderMinute: Int,
    val dailySummaryEnabled: Boolean,
    val dailySummaryHour: Int,
    val dailySummaryMinute: Int,
    val weightReminderEnabled: Boolean,
    val weightReminderHour: Int,
    val weightReminderMinute: Int,
    val bodyFatReminderEnabled: Boolean,
    val bodyFatReminderHour: Int,
    val bodyFatReminderMinute: Int,
    ...
    val mealPlanningEnabled: Boolean,
    ...
    val fastingStartHour: Int,
    val fastingStartMinute: Int,
...
internal fun Preferences.toSettingsHydration(json: Json): SettingsPrefsHydration {
    ...
    return SettingsPrefsHydration(
        ...
        energyUnit = this[Keys.ENERGY_UNIT] ?: "kcal",
        ...
        streakReminderHour = this[Keys.STREAK_HOUR] ?: 19,
        streakReminderMinute = this[Keys.STREAK_MINUTE] ?: 0,
        ...
        weightReminderHour = this[Keys.WEIGHT_REMINDER_HOUR] ?: 8,
        weightReminderMinute = this[Keys.WEIGHT_REMINDER_MINUTE] ?: 0,
        bodyFatReminderEnabled = this[Keys.BODY_FAT_REMINDER_ENABLED] ?: true,
        bodyFatReminderHour = this[Keys.BODY_FAT_REMINDER_HOUR] ?: 8,
        bodyFatReminderMinute = this[Keys.BODY_FAT_REMINDER_MINUTE] ?: 0,
        ...
        mealPlanningEnabled = this[Keys.MEAL_PLANNING_ENABLED] ?: false,
